...
/**
 *
 * @author kellie hughes and aidan durnin
 */
@WebServlet(urlPatterns = {"/PopPunk"})
public class PopPunk extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            String XMLFileName = path + "/musiczone.xml";
            String XSLFileName = path + "/poppunk.xsl";
